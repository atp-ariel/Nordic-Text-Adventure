...
inicialPassage = Passage 1 "Bienvenido a Loki Text Adventure\n\nCapítulo 1\nEres Loki, Señor del Caos, hijo de los gigantes Farbuti y Laufey. Se te conoce hasta ahora como conflictivo, egocéntrico y megalómano. Tu actuación en esta historia llevará a que reine la paz en el mundo o este se sumerja en un caos total. Tienes tres hijos el enorme lobo Fenrir, la diosa de la muerte Hela y la serpiente marina Jormundgander. Tu historia comienza en Asgard, estás caminando por el medio de la plaza cuando pasas cerca de una casa con la puerta abierta y una luz encendida." [] [housePassage]
...
competitionPassage = Passage 17 "Engañas a los enanos diciéndoles que los dioses han organizado un concurso para ver quien forja los mejores artículos. Como resultado Brok fabrica la cabellera dorada de Sift, el barco Skidblandnes y la lanza Gungnir. Por su parte Sindri fabrica un cerdo con sedas de oro, la argolla de oro Draupnir y el martillo Mjolnir. Cada uno de estos tesoros tiene diferentes propiedades mágicas. Entonces los enanos te preguntan acerca del concurso pero tu bien sabes que no existe tal cual. Básicamente tus opciones se reducen a viajar a Asgard y convencer a los dioses de realizar el concurso improvisado o robarte los tesoros descaradamente." ["concurso","enanos"] [convinceAesirPassage, stealTreasuresPassage]

convinceAesirPassage = Passage 18 "Viajas a Asgard y convences a Odín, Thor y Freyr de que actúen como jueces. Ellos acceden. El concurso se realiza y se escoge el martillo Mjolnir como el mejor de los tesoros. Los tres dioses se reparten los tesoros entre ellos y todos quedan felices y contentos. Este capítulo ha terminado, para pasar al siguiente escribe 'siguiente'." ["convencer"] [chapter2InicialPassage]

stealTreasuresPassage = Passage 19 "Al tratar de robar los tesoros, los enanos te capturan y te atan a una roca con una soga irrompible. Producto de esto no podrás escapar y quedarás encadenado para siempre. Así has llegado a tu fin." ["robar", "tesoros"] []
...
acceptEaglePassage = Passage 23 "El águila agradecida empieza a coger del asado pero coge demasiado y entonces decides espantarla pero esta te atrapa con sus garras y se eleva en el cielo contigo. Resulta que al águila es el gigante de la tormenta Thjazi disfrazado. A cambio de liberarte te ordena secuestrar a Idúnn, la guardiana de las manzanas de la inmortalidad (manzanas que comían los dioses para mantenerse jóvenes). Queda por ti decidir si aceptas o rechazas el trato." ["aceptar"] [rejectThjaziPassage,acceptThjaziPassage]
