...
Los casos de prueba son los siguientes: buscar una cadena en una lista de cadenas y devolver que si la encontró o no, hacer búsquedas que no sean case sensitive, y encontrar la cadena exacta y no subcadenas. Además se tiene que los sinónimos de un pasaje sin \verb|keywords| es el vacío ($\emptyset$), y obtener los sinónimos de las \verb|keywords| del segundo pasaje. Y dada la cadena ``entrar a la vivienda'' y el pasaje inicial, verificar que se obtenga el siguiente pasaje.
